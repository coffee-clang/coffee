...
int main(int argc, char **argv)
{
	...
	options opt = {
		...
		.pkg_version = (int)args_info.pkg_version_given ? args_info.pkg_version_arg : NULL,
		.path		 = (int)args_info.path_given ? args_info.path_arg : NULL,
		.git		 = (int)args_info.git_given ? args_info.git_arg : NULL,
		.branch		 = (int)args_info.branch_given ? args_info.branch_arg : NULL,
		.tag		 = (int)args_info.tag_given ? args_info.tag_arg : NULL,
		.rev		 = (int)args_info.rev_given ? args_info.rev_arg : NULL,
		.registry	 = (int)args_info.registry_given ? args_info.registry_arg : NULL,
		...
		.bin				 = (int)args_info.bin_given ? args_info.bin_arg : NULL,
		.example			 = (int)args_info.example_given ? args_info.example_arg : NULL,
		.features			 = (int)args_info.features_given ? args_info.features_arg : NULL,
		.all_features		 = args_info.all_features_given,
		.no_default_features = args_info.no_default_features_given,
		.profile			 = (int)args_info.profile_given ? args_info.profile_arg : NULL,
		.target				 = (int)args_info.target_given ? args_info.target_arg : NULL,
		.target_dir			 = (int)args_info.target_dir_given ? args_info.target_dir_arg : NULL,
		.manifest_path		 = (int)args_info.manifest_path_given ? args_info.manifest_path_arg : NULL,
