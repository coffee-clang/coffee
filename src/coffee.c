...
command_s commands[] = {
	...
	{.name = "fix", .description = "Automatically fix lint warnings reported by the compiler", .action = &handle_fix},
	{.name		  = "fmt",
	...
	{.name = "libs", .description = "Output linker flags for dependencies (pkg-config style)", .action = &handle_libs},
