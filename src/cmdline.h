...
struct gengetopt_args_info {
	...
	char *
		color_orig; /**< @brief Coloring [possible values: auto, always, never] original value given at command line. */
	...
	char *message_format_orig; /**< @brief Error format [possible values: human, json, short] original value given at
								  command line.  */
	...
	char *
		features_orig; /**< @brief Space-separated list of features to activate original value given at command line. */
	...
	const char
		 *ignore_rust_version_help; /**< @brief Ignore `rust-version` specification in packages help description.  */
	...
	char	   *pkg_version_arg;	 /**< @brief Version constraint.  */
	char	   *pkg_version_orig;	 /**< @brief Version constraint original value given at command line.  */
	const char *pkg_version_help;	 /**< @brief Version constraint help description.  */
