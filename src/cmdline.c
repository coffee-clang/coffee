/*
  ...
  gengetopt -i src/cli.ggo --output-dir=src/ --unamed-opts --strict-hidden --unamed-opts --strict-hidden
...
static void init_args_info(struct gengetopt_args_info *args_info)
{
	...
	args_info->fix_help					   = gengetopt_args_info_help[55];
	args_info->toolchain_help			   = gengetopt_args_info_help[56];
	args_info->command_help				   = gengetopt_args_info_help[57];
}
...
int cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
	...
	if (args_info->fix_given) {
		write_into_file(outfile, "fix", 0, 0);
	}
							...
							struct cmdline_parser_params *params, const char *additional_error)
{
	...
	while (1) {
		...
		case 0: /* Long option with no short option */
			...
			else if (strcmp(long_options[option_index].name, "fix") == 0) {

				if (update_arg((void *)&(args_info->fix_flag), 0, &(args_info->fix_given), &(local_args_info.fix_given),
							   optarg, 0, 0, ARG_FLAG, check_ambiguity, override, 1, 0, "fix", '-', additional_error)) {
					goto failure;
				}
